...
if ($_SERVER['REQUEST_METHOD'] == "POST" && strlen($_POST['username']) > 0 && strlen($_POST['password']) > 0) {
        ...
        if (isset($_POST['password'])) {
            ...
            if (!ctype_alnum($password)) {
                ...
                if (checkUserExists($user)) {
                    ...
                    registerUser($user, $password, $full_name, $email);
...
<head>
    ...
    <title>Restaurant Buddy - Register</title>
</head>
        ...
        <div class="row gx-lg-5 align-items-center mb-5">
            <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                ...
                <h1>Welcome to Restaurant Buddy<br />
                    <span style="color: hsl(218, 81%, 75%)">Connect with friends about eateries</span>
                </h1>
            ...
            <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                ...
                <div class="card bg-glass">
                    <div class="card-body px-4 py-5 px-md-5">
                        ...
                        <p>Already have an account? <a href="login.php" style="color: hsl(158, 39%, 34%);">Sign in!</a></p>
                    </div>
                </div>
            </div>
        </div>
