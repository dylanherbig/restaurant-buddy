...
if (isset($_POST['happy_hour'])) {
    session_start();
    $id = $_SESSION['id'];
    $happy_hour = $_POST['happy_hour'];
    addBar($id, $happy_hour);
                    ...
                    <div class="card-body px-4 py-5 px-md-5">
                        <form action="bar.php" method="post">
                            <div class="form-outline mb-4"> 
                                <label class="form-label">Happy Hour (ex: 5-6pm)</label>
                                <input type="text" name="happy_hour" class="form-control" required/>
                            </div>
                            <form action="bar.php" method="post">
